...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'pricing.day.popular': 'Recommended',
    'pricing.sprint.name': 'Three Day Sprint',
    'pricing.sprint.price': 'CHF 3000',
    ...
    'faq.a3':
      'Fixed prices, listed in the pricing section above: CHF 600 for a Blitz half day, CHF 1200 for a full prototype day, CHF 3000 for a three day sprint. Vereine and nonprofits get 20 percent off.',
  ...
  de: {
    ...
    'faq.a3':
      'Festpreise, siehe Preisliste oben: CHF 600 für einen halben Blitz Tag, CHF 1200 für einen ganzen Prototypentag, CHF 3000 für einen Sprint über drei Tage. Vereine und gemeinnützige Organisationen erhalten 20 Prozent Rabatt.',
